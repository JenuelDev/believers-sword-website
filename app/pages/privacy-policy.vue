<template>
    <main class="policy-page">
        <div class="policy-shell">
            <article class="policy-card">
                <header class="policy-header">
                    ...
                    <p class="policy-updated">Last updated: June 25, 2025</p>
                </header>
        <p>
        ...
        <ul>
            ...
            <li>
                <p>
                    ...
                    Company&quot;, &quot;We&quot;, &quot;Us&quot; or
                    &quot;Our&quot; in this Agreement) refers to Believers
                    Sword.
                </p>
            </li>
            <li>
            ...
            <li>
                <p>
                    <strong>Website</strong> refers to Believers Sword,
                    accessible from
                    <a
                        href="https://www.believersword.com/"
                        rel="external nofollow noopener"
                        target="_blank"
                        >https://www.believersword.com/</a
                    >
                </p>
            </li>
            <li>
        ...
        <ul>
            <li>By email: <a href="mailto:me@jenuel.dev">me@jenuel.dev</a></li>
        </ul>
            </article>
        </div>
        <SiteFooter />
